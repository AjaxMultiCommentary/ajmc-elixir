          ...
          >
            ...
            <div :if={@search_results != []} class="flex divide-x divide-slate-100">
              ...
              <div class="max-h-96 min-w-0 flex-auto scroll-py-4 overflow-y-auto px-6 py-4 sm:h-96">
                ...
                <ul class="-mx-2 text-sm text-slate-700" id="page-command-palette_search-results" role="listbox">
                  <.list_item
  ...
  def list_item(assigns) do
    ...
    >
      <section class="truncate">
        ...
        <p class="text-slate-400"><%= @version.description %></p>
      </section>
      <!-- Not Active: "hidden" -->
  ...
  def preview(assigns) do
    ...
    <div class="hidden h-96 w-1/2 flex-none flex-col divide-y divide-slate-100 overflow-y-auto sm:flex">
      <div class="flex-none p-6 text-center">
        <h2 class="mt-3 font-semibold text-slate-900"><%= @version.label %></h2>
        <h3 class="text-sm leading-6 text-slate-500">
          <%= @version.urn %>
        </h3>
        <p class="text-sm leading-6 text-slate-500"><%= @version.description %></p>
      </div>
