defmodule TextServerWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-primary/10 ring-primary/10 relative hidden rounded-2xl bg-white p-14 shadow-lg ring-1 transition"
            >
  ...
  def input(%{type: "checkbox", value: value} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 base-content">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-primary base-content focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def header(assigns) do
    ...
    <header class={[@actions != [] && "flex items-center justify-between gap-6", @class]}>
      <div>
        ...
        <p :if={@subtitle != []} class="mt-2 text-sm leading-6 base-content">
        ...
        <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
          <table class="min-w-full divide-y divide-primary">
            ...
            <tbody
              ...
              class="divide-y divide-primary bg-white"
            >
              <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-primary-50">
                ...
                <td :if={@action != []} class="relative w-14 p-0">
                  <div class="relative py-4 text-right text-sm font-medium">
                    ...
                    <span
                      :for={action <- @action}
                      class="relative ml-4 font-semibold leading-6 base-content hover:base-content"
                    >
  ...
  def list(assigns) do
    ~H"""
    <div class="mt-14">
      <dl class="-my-4 divide-y divide-primary">
        <div :for={item <- @item} class="flex gap-4 py-4 text-sm leading-6 sm:gap-8">
          <dt class="w-1/4 flex-none base-content"><%= item.title %></dt>
          <dd class="base-content"><%= render_slot(item) %></dd>
        </div>
      </dl>
    </div>
    """
  ...
  def back(assigns) do
    ~H"""
    <div class="mt-16">
      <.link navigate={@navigate} class="text-sm font-semibold leading-6 base-content hover:base-content">
