      ...
      >
        ...
        <div class="absolute right-0">
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            phx-click={JS.toggle() |> JS.toggle(to: "##{@id}-up-icon") |> JS.toggle(to: "#options-container-#{@id}")}
          >
            <path
              fill-rule="evenodd"
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            phx-click={JS.toggle() |> JS.toggle(to: "##{@id}-down-icon") |> JS.toggle(to: "#options-container-#{@id}")}
          >
            <path
              fill-rule="evenodd"
