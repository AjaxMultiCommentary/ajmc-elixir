...
#   - Ex: hexpm/elixir:1.15.7-erlang-26.1.2-ubuntu-jammy-20231004 
#   - or 1.15.7-erlang-26.1.2-debian-bullseye-20231009-slim
...
RUN apt-get update -y && apt-get install -y nodejs npm wget
...
RUN apt-get update -y && apt-get install -y libstdc++6 openssl libncurses5 locales pandoc \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
